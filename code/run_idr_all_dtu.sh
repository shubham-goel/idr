...
#SBATCH --output=/home/%u/checkpoint/jobs/idr-dtu-%A_%a.out
#SBATCH --error=/home/%u/checkpoint/jobs/idr-dtu-%A_%a.err
...
PREFIXES=("scan105"  "scan106"  "scan118"  "scan122"  "scan24"  "scan55"  "scan63"  "scan65"  "scan83")

# PREPROCESS
python -m preprocess.preprocess_cameras --source_dir /home/shubham/data/GSO_for_idr/dtu/r20t0h0/v6/${PREFIXES[$SLURM_ARRAY_TASK_ID]}/;
python -m preprocess.preprocess_cameras --source_dir /home/shubham/data/GSO_for_idr/dtu/r20t0h0/v6/${PREFIXES[$SLURM_ARRAY_TASK_ID]}/ --use_linear_init;

# TRAIN
python training/exp_runner.py --train_cameras --conf ./confs/dtu_trained_cameras_r20v6.conf --is_continue --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}

# EVAL
# python eva`luation/eval.py --conf ./confs/dtu_trained_cameras_r20v6.conf --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}
python evaluation/eval_export.py --conf ./confs/dtu_trained_cameras_r20v6.conf --eval_cameras --resolution 256 --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}
