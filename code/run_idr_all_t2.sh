...
#SBATCH --output=/home/%u/checkpoint/jobs/idr-t2-%A_%a.out
#SBATCH --error=/home/%u/checkpoint/jobs/idr-t2-%A_%a.err
...
# PREPROCESS
python -m preprocess.preprocess_cameras --source_dir /home/shubham/data/GSO_for_idr/tanks_and_temples/r0t0h0/v15/${PREFIXES[$SLURM_ARRAY_TASK_ID]}/;
python -m preprocess.preprocess_cameras --source_dir /home/shubham/data/GSO_for_idr/tanks_and_temples/r0t0h0/v15/${PREFIXES[$SLURM_ARRAY_TASK_ID]}/ --use_linear_init;

# TRAIN
python training/exp_runner.py --train_cameras --conf ./confs/t2_trained_cameras_r0v15.conf --is_continue --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}

# EVAL
# python evaluation/eval.py --conf ./confs/t2_trained_cameras_r0v15.conf --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}
python evaluation/eval_export.py --conf ./confs/t2_trained_cameras_r0v15.conf --eval_cameras --resolution 256 --scan_id ${PREFIXES[$SLURM_ARRAY_TASK_ID]}
