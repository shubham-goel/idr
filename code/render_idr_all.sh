...
#SBATCH --exclude=em3
#SBATCH --array=0-8
#SBATCH --comment="IDR render on GSO"
...
BLENDER_FILE=/home/shubham/code/3Dify/render_wireframe.py
ASIN=${PREFIXES[$SLURM_ARRAY_TASK_ID]}
OBJ_PATH=/home/shubham/code/idr/evals/dtu_trained_cameras_r0v6_$ASIN/surface_world_coordinates_2000.ply
OUT_PATH=/home/shubham/code/idr/renders/dtu_trained_cameras_r0v6/$ASIN-idr-img.png
blender -b -P $BLENDER_FILE -- --input_obj $OBJ_PATH --output $OUT_PATH
